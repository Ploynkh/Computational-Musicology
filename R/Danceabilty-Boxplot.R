...
danceability <- ggplot(rnb_tracks, aes(x = Era, y = Danceability, fill = Era)) +
  geom_boxplot(
    width = 0.5,
    alpha = 0.75,
    outlier.shape = NA,
  ...
  labs(
#    title = "Danceability Across R&B Eras",
#    subtitle = "1990s tracks are generally more danceable than 2020s tracks",
    y = "Danceability",
    x = NULL
  ) +
  theme(
